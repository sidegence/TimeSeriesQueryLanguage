...
{
    public class V1V2V3DecNode : AbstractNode
    {
        readonly List<AbstractNode> Args;
        public V1V2V3DecNode(List<AbstractNode> args)
        {
            if (args.Count != 3)
        ...
        public override async Task<decimal> Eval(ITimeSeriesQueryLanguageContext ctx)
        {
            ...
            return V1V2V3Dec(arg0, arg1, arg2);
        }
        public static decimal V1V2V3Dec(decimal v1, decimal v2, decimal v3)
        {
